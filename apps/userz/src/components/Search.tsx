      ...
      <form className="w-full flex-grow flex items-center" onSubmit={handleSubmit}>
        <div className="relative flex-grow">
          ...
          <input
            ...
            type="search"
            id="default-search"
            className="block p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-900 dark:bg-gray-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 w-full" // Updated width to take the whole width
