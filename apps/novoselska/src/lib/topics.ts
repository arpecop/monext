...
export const topics: Topic[] = [
  ...
  },
  {
    ...
    topic: "ADHD", id: 0, data: {
      ...
      "instruct": `Ако AI трябва да започне разговор с човек, страдащ от ADHD, е важно да се има предвид, че това е чувствително заболяване. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни за здравето на човека. Вместо това, AI може да предостави информация за заболяването и да насочи човека към професионален медицински съвет. AI може да предостави информация за начините, по които човек може да се справи с ADHD, като например стратегии за управление на времето, организация на задачите, медитация и физически упражнения. Важно е да се има предвид, че AI не може да замести професионален медицински съвет и че всеки, който страда от ADHD, трябва да се консултира с лекар.`
    }
  },
  {
    slug: "autism",
    topic: "Аутистичен спектър", id: 4, data: {
      ...
      "instruct": "Ако AI трябва да започне разговор с човек, страдащ от биполярно разстройство, е важно да се има предвид, че това е чувствително заболяване. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни за здравето на човека. Вместо това, AI може да предостави информация за заболяването и да насочи човека към професионален медицински съвет. AI може да предостави информация за лечението на биполярното разстройство, като например лекарства и терапии. Важно е да се има предвид, че AI не може да замести професионален медицински съвет и че всеки, който страда от биполярно разстройство, трябва да се консултира с лекар."
    }
  },
  {
    slug: "anxiety",
  ...
  },
  {
    ...
    topic: "Възстановяване", id: 35, data: {
      ...
      instruct: `  Ако AI трябва да започне разговор с човек, който се възстановява, е важно да се има предвид, че това е чувствително състояние. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни за здравето на човека. Вместо това, AI може да предостави информация за възстановяването и да насочи човека към професионален медицински съвет. AI може да предостави информация за начините, по които човек може да се възстанови, като например лекарства и терапии. Важно е да се има предвид, че AI не може да замести професионален медицински съвет и че всеки, който се възстановява, трябва да се консултира с лекар.`
    }
  ...
  },
  {
    ...
    Практикувайте медитация: Медитацията може да ви помогне да се успокоите и да се съсредоточите върху настоящото.
    Правете физически упражнения: Физическите упражнения могат да помогнат да се намали нивото на стреса и да се подобри настроението.`,
      instruct: ` Ако AI трябва да започне разговор с човек, страдащ от гранично разстройство на личността, е важно да се има предвид, че това е чувствително заболяване. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни за здравето на човека. Вместо това, AI може да предостави информация за заболяването и да насочи човека към професионален медицински съвет. AI може да предостави информация за лечението на граничното разстройство на личността, като например лекарства и терапии. Важно е да се има предвид, че AI не може да замести професионален медицински съвет и че всеки, който страда от гранично разстройство на личността, трябва да се консултира с лекар.`
    }
  },
  {
    slug: "depression",
    topic: "Депресия", id: 11, data: {
      info: `Ако страдате от депресия, е важно да знаете, че това е сериозно състояние и че има начини да се справите с това. Някои от начините, които можете да използвате, са:
        ...
        Практикувайте медитация: Медитацията може да ви помогне да се успокоите и да се съсредоточите върху настоящото.
        Правете физически упражнения: Физическите упражнения могат да помогнат да се намали нивото на стреса и да се подобри настроението.`,
      instruct: ` Ако AI трябва да започне разговор с човек, страдащ от депресия, е важно да се има предвид, че това е чувствително заболяване. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни за здравето на човека. Вместо това, AI може да предостави информация за заболяването и да насочи човека към професионален медицински съвет. AI може да предостави информация за лечението на депресията, като например лекарства и терапии. Важно е да се има предвид, че AI не може да замести професионален медицински съвет и че всеки, който страда от депресия, трябва да се консултира с лекар.`,
    }
  },
  {
    slug: 'diabetes',
  ...
  {
    slug: 'dissociative',
    topic: "Дисоциативни разстройства", id: 14, data: { info: "Дисоциативните разстройства са психични състояния, при които се наблюдава нарушение на нормалното функциониране на паметта, осъзнаването, идентичността или съзнанието. Тези разстройства могат да се проявят чрез различни симптоми, като амнезия, деперсонализация, дереализация и други. В тази категория ще намерите информация, която ще ви помогне да разберете какво са дисоциативните разстройства и как да се справите с тях.", instruct: "Ако AI трябва да започне разговор с човек, страдащ от дисоциативни разстройства, е важно да се има предвид, че това е чувствително заболяване. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни за здравето на човека. Вместо това, AI може да предостави информация за заболяването и да насочи човека към професионален медицински съвет. AI може да предостави информация за лечението на дисоциативните разстройства, като например психотерапия и фармакотерапия. Важно е да се има предвид, че AI не може да замести професионален медицински съвет и че всеки, който страда от дисоциативни разстройства, трябва да се консултира с лекар." }
  },
  {
    slug: 'domestic-violence',
    topic: "Домашно насилие", id: 15, data: { info: "Домашното насилие е форма на насилие, което се извършва в семейната или домашната среда. То може да включва физическо, емоционално, сексуално или икономическо насилие. Домашното насилие е сериозен проблем, който засяга много хора. В тази категория ще намерите информация, която ще ви помогне да разберете какво е домашното насилие и как да се справите с него.", instruct: "Ако AI трябва да започне разговор с човек, страдащ от домашно насилие, е важно да се има предвид, че това е чувствителен проблем. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни за здравето и безопасността на човека. Вместо това, AI може да предостави информация за наличните ресурси и организации, които могат да помогнат на потребителя да се справи с домашното насилие. Важно е да се има предвид, че AI не може да замести професионална помощ и че всеки, който страда от домашно насилие, трябва да потърси подходяща подкрепа." }
  },
  {
    slug: 'spirituality',
    topic: "Духовност", id: 43, data: { info: "Духовността е широк термин, който се отнася до вътрешното измерение на човешкото съществуване и връзката с нещо по-голямо от себе си. Тя може да включва вярвания, практики и ценности, свързани с религия, философия, морал и етика. Духовността може да бъде изразена и преживявана по различни начини и е уникална за всеки човек. В тази категория ще намерите информация, която ще ви помогне да разберете какво е духовност и как да я развивате.", instruct: "Ако AI трябва да започне разговор с човек, който се интересува от духовност, е важно да се има предвид, че това е личен и интимен аспект на живота. AI трябва да бъде уважителен и да избягва да налага вярвания или да дава съвети, които могат да бъдат вредни за потребителя. Вместо това, AI може да предостави информация за различни практики и ресурси, които могат да помогнат на потребителя да развие своята духовност. Важно е да се има предвид, че AI не може да замести личен опит и наставници в духовното развитие." }
  },
  {
    slug: 'women-issues',
    topic: "Женски проблеми", id: 46, data: { info: "Женските проблеми включват различни здравословни и социални въпроси, които засягат жените. Това може да включва физически проблеми като менструални цикли, бременност и менопауза, както и психически проблеми като депресия и тревожност. В тази категория ще намерите информация, която ще ви помогне да разберете и се справите с различните женски проблеми.", instruct: "Ако AI трябва да започне разговор с жена, страдаща от женски проблеми, е важно да се има предвид, че това е чувствителна тема. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни за здравето на жената. Вместо това, AI може да предостави информация за различните женски проблеми и да насочи жената към професионален медицински съвет. Важно е да се има предвид, че AI не може да замести професионален медицински съвет и че всяка жена трябва да се консултира с лекар." }
  },
  {
    slug: 'drug-alcohol-abuse',
    topic: "Злоупотреба с алкохол/наркотици", id: 2, data: { info: "Злоупотребата с алкохол и наркотици е сериозен проблем, който засяга много хора. Това може да има отрицателни последици за здравето, отношенията и обществото като цяло. В тази категория ще намерите информация, която ще ви помогне да разберете какво е злоупотребата с алкохол и наркотици и как да се справите с нея.", instruct: "Ако AI трябва да започне разговор с човек, злоупотребяващ с алкохол или наркотици, е важно да се има предвид, че това е чувствителен проблем. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни за здравето и безопасността на човека. Вместо това, AI може да предостави информация за наличните ресурси и организации, които могат да помогнат на потребителя да се справи с злоупотребата с алкохол и наркотици. Важно е да се има предвид, че AI не може да замести професионална помощ и че всеки, който злоупотребява с алкохол или наркотици, трябва да потърси подходяща подкрепа." }
  },
  {
    slug: "motivation",
    topic: "Мотивация", id: 17, data: { info: "Мотивацията за упражнения е важен фактор за поддържането на здравословен начин на живот. Тя може да включва вътрешни и външни фактори, които ви стимулират да се движите и да тренирате. В тази категория ще намерите информация, която ще ви помогне да намерите мотивацията си за упражнения и да я поддържате.", instruct: "Ако AI трябва да започне разговор с човек, който търси мотивация за упражнения, е важно да се има предвид, че мотивацията е индивидуален процес. AI може да предостави информация за различни начини за намиране на мотивация и поддържането й, като например поставяне на цели, намиране на интересни форми на тренировки и търсене на подкрепа от други хора. Важно е да се има предвид, че AI не може да замести личен мотивационен процес и че всеки трябва да намери своите собствени мотивиращи фактори." }
  },
  {
    slug: "men-issues",
    topic: "Мъжки проблеми", id: 27, data: { info: "Мъжките проблеми включват различни здравословни и социални въпроси, които засягат мъжете. Това може да включва физически проблеми като простатно здраве и сексуални проблеми, както и психически проблеми като депресия и тревожност. В тази категория ще намерите информация, която ще ви помогне да разберете и се справите с различните мъжки проблеми.", instruct: "Ако AI трябва да започне разговор с мъж, страдащ от мъжки проблеми, е важно да се има предвид, че това е чувствителна тема. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни за здравето на мъжа. Вместо това, AI може да предостави информация за различните мъжки проблеми и да насочи мъжа към професионален медицински съвет. Важно е да се има предвид, че AI не може да замести професионален медицински съвет и че всеки мъж трябва да се консултира с лекар." }
  },
  {
    slug: "ocd",
    topic: "Обсесивно-компулсивното разстройство", id: 28, data: { info: "Обсесивно-компулсивното разстройство (ОКР) е психично заболяване, при което се проявяват непрекъснати и неподконтролируеми мисли (обсесии) и повтарящи се действия (компулсии). Това може да включва навици, проверки, подреждане и други действия, които човекът изпълнява с цел да се освободи от тревогата, свързана с обсесиите. В тази категория ще намерите информация, която ще ви помогне да разберете какво е обсесивно-компулсивното разстройство и как да се справите с него.", instruct: "Ако AI трябва да започне разговор с човек, страдащ от обсесивно-компулсивно разстройство, е важно да се има предвид, че това е чувствително заболяване. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни за здравето на човека. Вместо това, AI може да предостави информация за заболяването и да насочи човека към професионален медицински съвет. AI може да предостави информация за лечението на обсесивно-компулсивното разстройство, като например психотерапия и фармакотерапия. Важно е да се има предвид, че AI не може да замести професионален медицински съвет и че всеки, който страда от обсесивно-компулсивно разстройство, трябва да се консултира с лекар." }
  },
  {
    slug: "mental-health",
    topic: "Общо психично здраве", id: 21, data: { info: "Общото психично здраве се отнася до психическото благополучие и функциониране на човека като цяло. То включва различни аспекти на живота, като емоционалното благополучие, управлението на стреса, междуличностните взAIмоотношения и способността за адаптация към промените. В тази категория ще намерите информация, която ще ви помогне да подобрите и поддържате общото си психично здраве.", instruct: "Ако AI трябва да започне разговор с човек, който се интересува от общото психично здраве, е важно да се има предвид, че това е индивидуален и комплексен аспект на живота. AI може да предостави информация за различни стратегии и ресурси, които могат да помогнат на потребителя да подобри и поддържа своето психично здраве. Важно е да се има предвид, че AI не може да замести професионална помощ и че всеки, който има нужда от подкрепа, трябва да потърси подходяща помощ от квалифициран специалист." }
  },
  {
    slug: "adoptions-foster-care",
    topic: "Осиновяване/приемна грижа", id: 1, data: { info: "Осиновяването или приемната грижа е процес, при който децата без родители получават нова семейна среда и грижа от приемни родители. Това може да се случи поради различни причини, като смърт на биологичните родители, злоупотреба или неблагоприятни условия за отглеждане. В тази категория ще намерите информация, която ще ви помогне да разберете какво е осиновяването и как да се справите с предизвикателствата, свързани с него.", instruct: "Ако AI трябва да започне разговор с човек, който се интересува от осиновяване или приемна грижа, е важно да се има предвид, че това е индивидуален и чувствителен процес. AI може да предостави информация за различните аспекти на осиновяването и да насочи потребителя към ресурси и организации, които могат да помогнат в процеса на осиновяване. Важно е да се има предвид, че AI не може да замести професионална помощ и че всеки, който се интересува от осиновяване или приемна грижа, трябва да се консултира с квалифициран специалист." }
  },
  {
    slug: 'lgbtq',
    topic: "Проблеми с LGBTQ+", id: 24, data: { info: "Проблемите, свързани с LGBTQ+, включват социални, психологически и здравни предизвикателства, с които се сблъскват хората от ЛГБТQ+ общността. Тези предизвикателства могат да включват дискриминация, стигма, насилие, проблеми с идентичността и сексуалността, както и здравни проблеми. В тази категория ще намерите информация, която ще ви помогне да разберете и се справите с проблемите, свързани с LGBTQ+.", instruct: "Ако AI трябва да започне разговор с човек, страдащ от проблеми, свързани с LGBTQ+, е важно да се има предвид, че това е чувствителна тема. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни или обидни за потребителя. Вместо това, AI може да предостави информация за наличните ресурси, организации и подкрепа, които могат да помогнат на потребителя да се справи с проблемите, свързани с LGBTQ+. Важно е да се има предвид, че AI не може да замести личен опит и професионална помощ." }
  },
  {
    slug: 'forgiveness',
    topic: "Прошка", id: 20, data: { info: "Прошката е процес на освобождаване от гняв, обиди и обидчивост и приемане на преживяната болка. Това е личен и емоционален процес, който може да помогне на хората да се освободят от негативните емоции и да намерят мир и примирение. В тази категория ще намерите информация, която ще ви помогне да разберете какво е прошката и как да я практикувате.", instruct: "Ако AI трябва да започне разговор с човек, който се интересува от прошка, е важно да се има предвид, че това е личен и интимен процес. AI може да предостави информация за различни подходи и техники за практикуване на прошката, като например изразяване на емоции, осъзнатост и работа със себе си. Важно е да се има предвид, че AI не може да замести личен опит и професионална помощ." }
  },
  {
    slug: 'razstroystvo-na-nastr',
    topic: "Перинатално разстройство на настроението", id: 33, data: { info: "Перинаталното разстройство на настроението (ПРН) е психично заболяване, което се проявява по време на бременността или след раждането. Жените с ПРН изпитват интензивни и продължителни симптоми на депресия, тревожност и настроеност. Това може да засегне тяхната способност да се грижат за себе си и за бебето си. В тази категория ще намерите информация, която ще ви помогне да разберете какво е ПРН и как да се справите с него.", instruct: "Ако AI трябва да започне разговор с жена, страдаща от перинатално разстройство на настроението, е важно да се има предвид, че това е чувствителна тема. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни за здравето на жената и на бебето. Вместо това, AI може да предостави информация за заболяването и да насочи жената към професионален медицински съвет. AI може да предостави информация за лечението на перинаталното разстройство на настроението, като например психотерапия и фармакотерапия. Важно е да се има предвид, че AI не може да замести професионален медицински съвет и че всяка жена трябва да се консултира с лекар." }
  },
...

  {
    ...
    data: {
      ...
      instruct: "Ако AI трябва да започне разговор с човек, страдащ от работен стрес, е важно да се има предвид, че това е често срещан проблем в работната среда. AI може да предостави информация за различни стратегии за управление на работния стрес, като например установяване на граници, планиране на времето и използване на техники за релаксация. Важно е да се има предвид, че AI не може да замести професионална помощ и че всеки, който страда от работен стрес, трябва да се консултира със специалист."
    }
  },
  {
    topic: "Раздяла",
    ...
    data: {
      ...
      instruct: "Ако AI трябва да започне разговор с човек, преживяващ раздяла, е важно да се има предвид, че това е чувствителна ситуация. AI може да предостави информация за различни стратегии за справяне с раздялата, като например търсене на подкрепа от близки и приятели, изразяване на емоции и работа със собствените нужди и грижи. Важно е да се има предвид, че AI не може да замести професионална помощ и че всеки, който преживява раздяла, може да се консултира с терапевт или психолог."
    }
  },
  {
    ...
    data: {
      ...
      instruct: "Ако AI трябва да започне разговор с човек, страдащ от разстройство на личността, е важно да се има предвид, че това е чувствително заболяване. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни за здравето на човека. Вместо това, AI може да предостави информация за различните видове разстройства на личността и да насочи човека към професионален медицински съвет. AI може да предостави информация за лечението на разстройството на личността, като например психотерапия и фармакотерапия. Важно е да се има предвид, че AI не може да замести професионален медицински съвет и че всеки, който страда от разстройство на личността, трябва да се консултира с лекар."
    }
  },
  {
    topic: "Рак",
    ...
    data: {
      ...
      instruct: "Ако AI трябва да започне разговор с човек, засегнат от рак, е важно да се има предвид, че това е чувствителна и трудна ситуация. AI трябва да предостави информация за различните видове рак и техните симптоми, диагностика и лечение. Важно е да се подчертае, че AI не може да замести професионална медицинска помощ и че всеки, който е засегнат от рак, трябва стриктно да се консултира с лекар и да получи подходящо лечение и подкрепа."
    }
  },
  {
    ...
    data: {
      ...
      instruct: "Ако AI трябва да започне разговор с човек, който се интересува от расовата и културната идентичност, е важно да се има предвид, че това е индивидуален и чувствителен аспект на самоличността. AI трябва да предостави информация за различните аспекти на расовата и културната идентичност и да насочи потребителя към ресурси и организации, които могат да помогнат в процеса на самооткриване и приемане на собствената идентичност. Важно е да се има предвид, че AI не може да замести личен опит и професионална помощ."
    }
  },
  {
    topic: "Родителство",
    ...
    data: {
      ...
      instruct: "Ако AI трябва да започне разговор с човек, който се интересува от родителство, е важно да се има предвид, че това е индивидуален и отговорен процес. AI може да предостави информация за различните аспекти на родителството, като например бременност, раждане, грижи за бебето и възпитание на децата. Важно е да се подчертае, че AI не може да замести личен опит и професионална помощ. Човекът трябва да се консултира със специалист или да се обърне към надеждни източници на информация за конкретни въпроси и нужди, свързани с родителството."
    }
  },
  {
    topic: "Самонаранявам",
    ...
    data: {
      ...
      instruct: "Ако AI трябва да започне разговор с човек, който се самонаранява, е важно да се има предвид, че това е чувствителна и трудна ситуация. AI трябва да бъде внимателен и да избягва да дава съвети, които могат да бъдат вредни за здравето на човека. Вместо това, AI може да насочи човека към професионална помощ, като например психотерапия или консултация с психиатър. Важно е да се подчертае, че AI не може да замести професионална помощ и че всеки, който се самонаранява, трябва да потърси подходяща помощ и подкрепа."
    }
  },
  {
    topic: "самота",
  ...
  { topic: "Самочувствие", id: 38, slug: "samochuvstvie", data: { info: "", instruct: "" } },
  {
    ...
    data: {
      ...
      instruct: "Изразете съчувствие и разбиране към човека. Предоставете информация за различните аспекти на сексуалното здраве, като сексуалното образование, превенция на болести и нежелана бременност, сексуалните права и отношенията. Подчертайте, че AI не може да замести личен опит и професионална помощ. Насочете човека към специалисти или надеждни източници на информация при нужда."
    }
  },
  {
    topic: "Семеен стрес",
  ...
  },
  {
    ...
    data: {
      ...
      Подчертавайте, че AI не може да замести личния опит и професионална помощ.
